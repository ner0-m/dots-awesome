...
launcherDisplay:setup({
	{
		...
		},
		{
			{
				{
					textbutton({ text = "", size = "15", onclick = "firefox" }),
					textbutton({ text = "", size = "15", onclick = "alacritty" }),
					textbutton({ text = "", size = "15", onclick = "dolphin" }),
					expand = "none",
					layout = wibox.layout.align.horizontal,
				},
				{
...
awesome.connect_signal("widget::launcher", function()
	...
	awful.placement.top_left(launcherDisplay, {
		margins = {
			top = dpi(55),
			left = dpi(15),
		},
