...
local icon = wibox.widget({
	...
	stylesheet = " * { stroke: " .. beautiful.green .. " } circle { fill: " .. beautiful.bg_subtle .. "; }",
	forced_width = 30,
	valign = "center",
	halign = "center",
})
...
wifi:buttons({
	awful.button({}, 1, function()
		...
		if s then
			icon.stylesheet =
				" * { stroke: " .. beautiful.green .. " } circle { fill: " .. beautiful.green .. "; }",
				awful.spawn("nmcli radio wifi on")
		else
			icon.stylesheet =
				" * { stroke: " .. beautiful.black .. " } circle { fill: " .. beautiful.black .. "; }",
